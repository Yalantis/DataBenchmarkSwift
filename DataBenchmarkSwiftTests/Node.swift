...
class BinaryTreeNode<K: Comparable, V>: Node<DataStorage<K, V>> {
    ...
    fileprivate weak var parent: BinaryTreeNode<K, V>?
    fileprivate var left: BinaryTreeNode<K, V>?
    fileprivate var right: BinaryTreeNode<K, V>?
    
    fileprivate var type: BinaryNodeType {
        if (self.parent == nil) {
            return .Root
        }
